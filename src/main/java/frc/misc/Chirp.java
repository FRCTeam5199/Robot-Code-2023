 ...
 * in {@link Robot} that will help remove ghost files. Use this like an {@link Orchestra} with extra steps
 */
public class Chirp extends Orchestra implements ISubsystem {
    /**
     * Contains all of the talons created in {@link TalonMotorController#TalonMotorController(int, String)} that can be used to
     * play awesome tunez
     */
