...
public abstract class DefaultConfig {
    ...
    public double[][] red2DScoringArray = new double[][]{
            {-7.5 ,-7.5 ,-6.9 ,16.1  ,0 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,14.3 ,0 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,12.3   ,0 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,10.6   ,0 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,9.0    ,0 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,6.48   ,0 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,5.63    ,0 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,3.52   ,0 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,1.8   ,0 ,0.5}
    };
    ...
    public double[][] blue2DScoringArray = new double[][]{
            {-7.5 ,-7.5 ,-6.9 ,16.65  ,180 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,14.475 ,180 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,12.9   ,180 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,11.4  ,180 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,9.0    ,180 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,7.2   ,180 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,5.6    ,180 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,3.6   ,180 ,0.5},
            {-7.5 ,-7.5 ,-6.9 ,1.8   ,180 ,0.5}
    };
