...
public enum AutonRoutines {
    ...
    AUTON_PLACE_2_ANTIHP_RED(
            ...
            new AutonWaypoint(new Point(-3.2, 1.5), .25, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, 0,-195),
            new AutonWaypoint(new Point(-3.2, 1.5), .25, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, -1,-240),
            new AutonWaypoint(INTAKE_PISTON_OUT),
            new AutonWaypoint(INTAKE_WHEEL_OUT),
            new AutonWaypoint(new Point(-54 + 16, 3.55), .45, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, -37,-30),
            new AutonWaypoint(new Point(-54 + 21, 3.55), .45, DRIVE_TO, 1, DRIVE_TO_CUBE),
    ...
    AUTON_PLACE_2_ANTIHP_BLUE(
            ...
            new AutonWaypoint(new Point(-50.8, 1.5), .25, DRIVE_TO, 180,  ARM_ELEVATOR_GO_TO, -0,-195),
    ...
    AUTON_PLACE_2_HP_RED(
            ...
            new AutonWaypoint(new Point(-3.2, 15.2), .25, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, 0,-200),
            ...
            new AutonWaypoint(INTAKE_WHEEL_OFF),
            new AutonWaypoint(new Point(-5.8, 13.3), .43, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, -1,-220),
            new AutonWaypoint(INTAKE_WHEEL_IN),
            new AutonWaypoint(new Point(-14, 8), .7, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, -44,-140),
            new AutonWaypoint(AUTO_LEVEL),
    ...
    AUTON_PLACE_2_HP_RED(
            ...
            new AutonWaypoint(new Point(-3.2, 15.2), .25, DRIVE_TO, 1, ARM_ELEVATOR_UP),
            new AutonWaypoint(new Point(-3.2, 15.2), .25, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, 2,-60),
            new AutonWaypoint(new Point(-3.2, 15.2), .25, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, 0,-195),
            new AutonWaypoint(new Point(-3.1, 15.2), .25, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, -1,-225),
            new AutonWaypoint(INTAKE_PISTON_OUT),
            new AutonWaypoint(INTAKE_WHEEL_OUT),
            //new AutonWaypoint(new Point(-17, 14.2), .5, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, -35,-33),,
            new AutonWaypoint(new Point(-17, 14.9), .4, DRIVE_TO, 1, ARM_ELEVATOR_GO_TO, -37,-33),
            new AutonWaypoint(new Point(-20.5, 14.9), .15, DRIVE_TO, 1, ARM_ELEVATOR_GO_TO, -37,-33),
            new AutonWaypoint(INTAKE_WHEEL_OFF),
            new AutonWaypoint(new Point(-5.8, 14.1), .36, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, -1,-220),
            new AutonWaypoint(INTAKE_WHEEL_IN),
            new AutonWaypoint(new Point(-13.15, 8.5), .5, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, -44,-140),
            new AutonWaypoint(AUTO_LEVEL),
            new AutonWaypoint(LOCK_WHEELS)
    ...
    AUTON_PLACE_2_HP_BLUE(
            ...
            new AutonWaypoint(new Point(-54 + 3.5, 15.2), .25, DRIVE_TO, 180,  ARM_ELEVATOR_GO_TO, 0,-195),
    ...
    CLIMB_RED(
            ...
            new AutonWaypoint(new Point(-3.2, 8), 1, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, 0,-195),
            ...
            new AutonWaypoint(new Point(-14, 10), 1.2, DRIVE_TO, 1),
            new AutonWaypoint(AUTO_LEVEL),
            new AutonWaypoint(WAIT500),
            new AutonWaypoint(ARM_ELEVATOR_SHIFT_WEIGHT),
            new AutonWaypoint(LOCK_WHEELS)
    ...
    CLIMB_BLUE(
            ...
            new AutonWaypoint(new Point(-54 + 3.2, 8), 1, DRIVE_TO, 180,  ARM_ELEVATOR_GO_TO, 0,-200),
            ...
            new AutonWaypoint(new Point(-54 + 12, 10), 1.2, DRIVE_TO, 180),
            new AutonWaypoint(AUTO_LEVEL),
            new AutonWaypoint(WAIT500),
            new AutonWaypoint(ARM_ELEVATOR_SHIFT_WEIGHT),
            new AutonWaypoint(LOCK_WHEELS)
