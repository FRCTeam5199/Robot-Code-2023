...
public enum AutonRoutines {
    ...
    AUTON_PLACE_2_HP_RED(
            ...
            new AutonWaypoint(new Point(-18, 14.9), .33, DRIVE_TO, 1, ARM_ELEVATOR_GO_TO, -37,-33),
            new AutonWaypoint(new Point(-20.5, 14.9), .20, DRIVE_TO, 1, ARM_ELEVATOR_GO_TO, -37,-33),
    ...
    AUTON_PLACE_2_HP_BLUE(
            ...
            new AutonWaypoint(INTAKE_WHEEL_OUT),
            //new AutonWaypoint(new Point(-17, 14.2), .5, DRIVE_TO, 1,  ARM_ELEVATOR_GO_TO, -35,-33),,
            new AutonWaypoint(new Point(-54 + 18, 14.9), .33, DRIVE_TO, 180, ARM_ELEVATOR_GO_TO, -37,-33),
            new AutonWaypoint(new Point(-54 + 21.5, 14.9), .20, DRIVE_TO, 180, ARM_ELEVATOR_GO_TO, -37,-33),
            new AutonWaypoint(INTAKE_WHEEL_OFF),
    ...
    CLIMB_BLUE(
            ...
            new AutonWaypoint(new Point(-54 + 3.2, 8), 1, DRIVE_TO, 180,  ARM_ELEVATOR_GO_TO, -1,-225),
            new AutonWaypoint(INTAKE_PISTON_OUT),
            ...
            new AutonWaypoint(new Point(-54 + 11, 10), 1.2, DRIVE_TO, 180),
            new AutonWaypoint(AUTO_LEVEL),
            new AutonWaypoint(WAIT500),
            new AutonWaypoint(ARM_ELEVATOR_SHIFT_WEIGHT),
            new AutonWaypoint(LOCK_WHEELS)
