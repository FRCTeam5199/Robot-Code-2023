...
public enum AutonRoutines {
    ...
    AUTON_PLACE_2_ANTIHP_RED(
            new AutonWaypoint(new Point(-5.4, 1.6), .25, DRIVE_TO, 2),
            new AutonWaypoint(INTAKE_PISTON_IN),
            new AutonWaypoint(WAIT500),
            new AutonWaypoint(new Point(-5.4, 1.6), 1, DRIVE_TO, 2, ARM_ELEVATOR_UP),
            new AutonWaypoint(new Point(-5.4, 1.6), 1, DRIVE_TO, 2,  ARM_ELEVATOR_GO_TO, 2,-60),
            new AutonWaypoint(new Point(-5.4, 1.6), 1, DRIVE_TO, 2,    ARM_ELEVATOR_GO_TO, -3,-207),
            new AutonWaypoint(new Point(-5.4, 1.6), 1, DRIVE_TO, 2,  ARM_ELEVATOR_GO_TO, -2,-220),
            new AutonWaypoint(INTAKE_PISTON_OUT),
            new AutonWaypoint(INTAKE_WHEEL_BOTTOM_IN),
            new AutonWaypoint(new Point(-18, 4), .3, DRIVE_TO, 1, ARM_ELEVATOR_GO_TO, -44,-140),
            new AutonWaypoint(new Point(-24, 4.2), .3, DRIVE_TO, 1),
            new AutonWaypoint(new Point(-9, 3.2), .3, DRIVE_TO, 1),
            new AutonWaypoint(INTAKE_WHEEL_BOTTOM_OFF),
            new AutonWaypoint(new Point(-8.1, 3.2), .3, DRIVE_TO, 170),
    ...
    */
    AUTON_PLACE_2_HP_RED(
            ...
            new AutonWaypoint(new Point(-24.5, 15.9), .34, DRIVE_TO, 1),
            new AutonWaypoint(new Point(-9, 14.8), .3, DRIVE_TO, 1),
            new AutonWaypoint(INTAKE_WHEEL_BOTTOM_OFF),
            new AutonWaypoint(new Point(-8.1, 13.2), .3, DRIVE_TO, 170),
    ...
    CLIMB_RED_MOBILITY(
            ...
            new AutonWaypoint(new Point(-5.4, 8), 1, DRIVE_TO, 2,  ARM_ELEVATOR_GO_TO, -2,-220),
            new AutonWaypoint(INTAKE_PISTON_OUT),
            new AutonWaypoint(new Point(-18, 11), 1.4, DRIVE_TO, 1, ARM_ELEVATOR_GO_TO, -44,-140),
            new AutonWaypoint(WAIT100),
            new AutonWaypoint(new Point(-24, 12), .7, DRIVE_TO, 1, ARM_ELEVATOR_GO_TO, -44,-140),
            new AutonWaypoint(new Point(-14, 11), 1.4, DRIVE_TO, 1, ARM_ELEVATOR_GO_TO, -44,-140),
            new AutonWaypoint(AUTO_LEVEL),
            new AutonWaypoint(WAIT1000),
            new AutonWaypoint(AUTO_LEVEL),
            new AutonWaypoint(ARM_ELEVATOR_SHIFT_WEIGHT),
