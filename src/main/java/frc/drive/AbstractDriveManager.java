...
public abstract class AbstractDriveManager implements ISubsystem {
    ...
    public abstract void drivePure(double forward, double omega);

    public abstract void drivePure(double forward, double sideways, double omega);
    ...
    protected double adjustedDriveVoltage(double input, double mult) {
        ...
        return Math.signum(calc) * Math.min(12, Math.abs(calc));
    }
